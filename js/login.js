...
function check() {
    ...
    if (emailInputContent == "admin@yopmail.com" && passwordInputContent == "adminyopmail") {
        $.ajax("https://cors-anywhere.herokuapp.com/http://dataservice.accuweather.com/forecasts/v1/daily/5day/56186?apikey=5gSsn49PUUYs8PcEJ4x4UGdRKYksFnxE&metric=true").done(weather);
